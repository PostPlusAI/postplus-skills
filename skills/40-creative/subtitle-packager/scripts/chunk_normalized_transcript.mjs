...
function usage() {
  console.error("Usage: node chunk_normalized_transcript.mjs --input <normalized-transcript.json> --output <chunked.json> [--chunk-mode basic]");
}
...
async function main() {
  ...
  console.log(JSON.stringify({
    ...
    sourceSegmentCount: Array.isArray(payload.segments) ? payload.segments.length : 0,
    chunkedSegmentCount: Array.isArray(chunked.segments) ? chunked.segments.length : 0,
