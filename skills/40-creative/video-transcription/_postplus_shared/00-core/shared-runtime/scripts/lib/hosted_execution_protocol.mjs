...
export function readSkillExecutionEnvelope(value) {
  ...
  if (
    value.schemaVersion === HOSTED_SKILL_EXECUTION_SCHEMA_VERSION &&
...
export function readSkillExecutionInput(value) {
  return readSkillExecutionEnvelope(value).input;
}
