...
function usage() {
  ...
  node postplus_workspace.mjs serve [--project <slug-or-path>] [--projects-root <dir>] [--studio-root <dir>] [--host 127.0.0.1] [--port 3978] [--dashboard-dist <dir>] [--enable-fixture-launch] [--quiet-url-log]
