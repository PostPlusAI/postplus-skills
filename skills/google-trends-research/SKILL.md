...
- TikTok content heat or hook patterns -> `skills/tiktok-research`
- Instagram creator, account, or campaign scouting -> `skills/instagram-account-research` or `skills/instagram-campaign-scout`
- Amazon marketplace demand -> `skills/amazon-research`
...
- cross-source sourcing or selection judgment -> `skills/sourcing-selection`
