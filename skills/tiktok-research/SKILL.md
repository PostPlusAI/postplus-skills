...
- `${CLAUDE_SKILL_DIR}/../shared-release-shell-rules.md`
...
In the product-shell runtime, follow `${CLAUDE_SKILL_DIR}/../shared-release-shell-rules.md`.
...
For multi-step TikTok music workflows, read `${CLAUDE_SKILL_DIR}/../shared-tiktok-music-workflow.md`.
