...
- broad cross-platform social research routing -> `skills/social-media-extractor`
- cross-platform creator discovery routing -> `skills/creator-discovery-router`
- Google search-intent and topic momentum -> `skills/google-trends-research`
- TikTok platform data -> `skills/tiktok-research`
- TikTok ad creative research -> `skills/tiktok-ad-research`
- TikTok Shop platform data -> `skills/tiktok-shop-research`
- Amazon platform data -> `skills/amazon-research`
- 1688 product or supplier data -> `skills/1688-research`
- Instagram creator discovery -> `skills/instagram-creator-discovery`
- Instagram creator/account research -> `skills/instagram-account-research`
- Instagram content benchmark -> `skills/instagram-content-benchmark`
- Instagram audience language -> `skills/instagram-audience-voice`
- Instagram hashtag/tagged campaign scouting -> `skills/instagram-campaign-scout`
- X account/topic graph research -> `skills/x-research`
- LinkedIn company and content research -> `skills/linkedin-research`
- YouTube channel and video research -> `skills/youtube-research`
- Facebook page and post research -> `skills/facebook-research`
...
- use `skills/creator-discovery-router`
...
- start with `skills/social-media-extractor`
