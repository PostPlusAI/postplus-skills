...
If the user appears to want a broader TikTok research outcome, proactively mention that `skills/tiktok-research` can first build the shortlist this skill should analyze.
...
```bash
node skills/video-analysis/scripts/run_video_analysis_batch.mjs \
...
```bash
node skills/video-analysis/scripts/backfill_master_table_with_script.mjs \
